//                     xSDK example for MFEM + HiOp based on
//                       MFEM Example 9 - Parallel Version
//               Nonlinear Constrained Optimization Modification
//
// Compile with: make adv
//
// Sample runs:
//    mpirun -np 4 ./adv
//    mpirun -np 4 ./adv -opt 1
//
//    mpirun -np 4 ./adv -m ../data/periodic-segment.mesh -rs 3 -p 0 -o 2 -dt 0.002 -opt 1
//    mpirun -np 4 ./adv -m ../data/periodic-segment.mesh -rs 3 -p 0 -o 2 -dt 0.002 -opt 2
//
//    mpirun -np 4 ./adv -m ../data/periodic-square.mesh -p 0 -rs 2 -dt 0.01 -tf 10 -opt 1
//    mpirun -np 4 ./adv -m ../data/periodic-square.mesh -p 0 -rs 2 -dt 0.01 -tf 10 -opt 2
//
//    mpirun -np 4 ./adv -m ../data/periodic-square.mesh -p 1 -rs 2 -dt 0.005 -tf 9 -opt 1
//    mpirun -np 4 ./adv -m ../data/periodic-square.mesh -p 1 -rs 2 -dt 0.005 -tf 9 -opt 2
//
//    mpirun -np 4 ./adv -m ../data/amr-quad.mesh -p 1 -rs 1 -dt 0.002 -tf 9 -opt 1
//    mpirun -np 4 ./adv -m ../data/amr-quad.mesh -p 1 -rs 1 -dt 0.002 -tf 9 -opt 2
//
//    mpirun -np 4 ./adv -m ../data/disc-nurbs.mesh -p 1 -rs 2 -dt 0.005 -tf 9 -opt 1
//    mpirun -np 4 ./adv -m ../data/disc-nurbs.mesh -p 1 -rs 2 -dt 0.005 -tf 9 -opt 2
//
//    mpirun -np 4 ./adv -m ../data/disc-nurbs.mesh -p 2 -rs 2 -dt 0.01 -tf 9 -opt 1
//    mpirun -np 4 ./adv -m ../data/disc-nurbs.mesh -p 2 -rs 2 -dt 0.01 -tf 9 -opt 2
//
//    mpirun -np 4 ./adv -m ../data/periodic-square.mesh -p 3 -rs 3 -dt 0.0025 -tf 9 -opt 1
//    mpirun -np 4 ./adv -m ../data/periodic-square.mesh -p 3 -rs 3 -dt 0.0025 -tf 9 -opt 2
//
//    mpirun -np 4 ./adv -m ../data/periodic-cube.mesh -p 0 -rs 2 -o 2 -dt 0.02 -tf 8 -opt 1
//    mpirun -np 4 ./adv -m ../data/periodic-cube.mesh -p 0 -rs 2 -o 2 -dt 0.02 -tf 8 -opt 2
...
int main(int argc, char *argv[])
{
   ...
   if (visit)
   {
      if (binary)
      {
         ...
         dc = new SidreDataCollection("Advection", pmesh);
#else
      ...
      {
         dc = new VisItDataCollection("Advection", pmesh);
   ...
   *u = *U;
   ...
   //     using GLVis: "glvis -np <np> -m adv-mesh -g adv-final".
   {
      *u = *U;
