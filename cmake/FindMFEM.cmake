...
if(MFEM_FOUND)
  ...
  if(ENABLE_CUDA)
    string(REPLACE "-Xlinker=" "-Wl," MFEM_EXT_LIBS "${MFEM_EXT_LIBS}")
  endif()
  separate_arguments(MFEM_TPLFLAGS_LIST UNIX_COMMAND "${MFEM_TPLFLAGS}")
  separate_arguments(MFEM_EXT_LIBS_LIST UNIX_COMMAND "${MFEM_EXT_LIBS}")
  # message(STATUS "MFEM_TPLFLAGS_LIST: ${MFEM_TPLFLAGS_LIST}")
  # message(STATUS "MFEM_EXT_LIBS_LIST: ${MFEM_EXT_LIBS_LIST}")
  set_target_properties(XSDK::MFEM PROPERTIES
    INTERFACE_INCLUDE_DIRECTORIES "${MFEM_INCLUDE_DIRS}"
    INTERFACE_COMPILE_OPTIONS "${MFEM_TPLFLAGS_LIST}"
    INTERFACE_LINK_LIBRARIES "${MFEM_LIBRARY};${MFEM_EXT_LIBS_LIST}")
