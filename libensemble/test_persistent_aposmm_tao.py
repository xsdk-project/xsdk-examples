...
#    python3 test_persistent_aposmm_tao.py --nworkers 3 --comms tcp
#
...
from persistent_aposmm import aposmm as gen_f
from persistent_aposmm_alloc import persistent_aposmm_alloc as alloc_f
